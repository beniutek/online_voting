...
We use `rspec` to run tests in eahc of our project. Also we use `simplecov` to document the test coverage. You can see example output [here](https://beniutek.github.io/online_voting/counter/coverage/index.html).
#### Code documentation:
